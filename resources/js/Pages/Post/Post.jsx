    ...
    const columns = [
        ...
        },
        {
            ...
            getActions: (params) => [
                <Button
                    variant="warning"
                    onClick={() => handledDetail(params.row.id)}
                                    ...
                                    <Row>
                                        ...
                                        <Col sm={12} md={2} lg={3}>
                                            ...
                                            >
                                                ...
                                                <Form.Control
                                                    type="number"
                                                    placeholder="Nhập vị trí bài viết..."
                                                    value={position}
                                                    onChange={(e) =>
                                                        setPosition(
                                                            e.target.value
                            ...
                            >
                                <Row>
                                    ...
                                    <Gallery
                                        ...
                                        onSelectImages={handleSelectImages2}
                                    />
                                    <Col sm={12} md={2} lg={3}>
                                        <Form.Group
                                            className="mb-3"
